...
export function MobileShell({ children, overlay }: MobileShellProps) {
  ...
  return (
    <div className="min-h-dvh bg-[radial-gradient(circle_at_top,rgba(241,70,53,0.1),transparent_34%),linear-gradient(180deg,#f8fafc_0%,#eef3f8_100%)] px-0 py-0 sm:px-4 sm:py-4">
      <div className="relative mx-auto flex h-[100dvh] min-h-0 w-full max-w-[430px] flex-col overflow-hidden rounded-[32px] bg-[#eef7fb] shadow-2xl">
        ...
        <div className="relative flex min-h-0 w-full flex-1 flex-col">
          <header className="shrink-0 border-b border-border/80 bg-white/90 px-4 py-3 backdrop-blur">
          ...
          <nav className="shrink-0 border-t border-border bg-white px-4 pb-[calc(0.75rem+env(safe-area-inset-bottom))] pt-2">
            <div
              className={cn(
                'grid gap-2',
